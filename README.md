...
KDSelector learns to recommend a suitable anomaly detector for an unseen time series by reusing knowledge from historical benchmark results. It further employs data-efficient learning to reduce selector-training cost. KDSelector is the algorithm behind our **SIGMOD 2025** work, while the extended algorithmic details and comprehensive analyses are presented in our **PVLDB 2026** paper; see the [paper](https://doi.org/10.14778/3819518.3819525) and [repository](https://github.com/chenyuanTKCY/KDSelectorAlgorithm) for details.
